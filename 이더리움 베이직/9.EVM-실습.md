...
EVM은 명령 실행을 위해 **스택 데이터 구조**를 사용합니다. 
...
>
> 지갑은 사용자가 이더리움 계정과 상호작용할 수 있는 사용자 인터페이스 또는 애플리케이션입니다. 월드 상태에서는 그 지갑 주소를 계정에 매핑해야 합니다. 그 데이터는 바로 월드 상태에서 들고 있습니다.
>
